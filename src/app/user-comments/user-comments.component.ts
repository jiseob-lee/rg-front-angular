    ...
    router.events.subscribe((e) => {
      if (e instanceof NavigationEnd) {
        ...
        if (
          ...
          let cookieLang = this.cookieService.get(
...
*/
  ...
  checkLength(e: KeyboardEvent) {
    ...
    if (e.keyCode != 8 && val.length >= maxLength) {
      // 8 : 백스페이스키
      if (this.locale == 'ko') {
  ...
  inputComment() {
    ...
    this.http
      .post('https://jisblee.me/inputComment.do', body.toString(), {
